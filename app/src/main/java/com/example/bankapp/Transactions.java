...
public class Transactions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setHomeButtonEnabled(true);
            ...
            mRecyclerView = findViewById(R.id.transaction_recyclerview);
        ...
        private void showData() {
            ...
            Cursor cursor = new CustomerDbHelper(this).readTransactionData();
            ...
            adapter = new TransactionAdapter(Transactions.this, modelList_historylist);
