...
public class CustomerData extends AppCompatActivity {
    ...
    private void showData(String phonenumber) {
        Cursor cursor = new CustomerDbHelper(this).readOnlyThis(phonenumber);
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mAmount.getText().toString().isEmpty()){
                    ...
                    Intent intent = new Intent(CustomerData.this, sendMoney.class);
        ...
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        new CustomerDbHelper(CustomerData.this).insertTransferData(date, name.getText().toString(), "Not selected", "0", "Failed");
    ...
    public void onBackPressed() {
        startActivity(new Intent(CustomerData.this, Customers.class));
        finish();
    }
